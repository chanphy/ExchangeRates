...
public class CurrencyAdapter extends RecyclerView.Adapter<CurrencyAdapter.CustomViewHolder> {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        TextView CharCode,Scale, Name, Rate;

        public CustomViewHolder(View itemView) {
            super(itemView);
            CharCode = (TextView)itemView.findViewById(R.id.txt_char_code);
            Scale = (TextView)itemView.findViewById(R.id.txt_currency_name);
            Name = (TextView)itemView.findViewById(R.id.txt_currency_name);
            Rate = (TextView)itemView.findViewById(R.id.txt_currency_today_value);
